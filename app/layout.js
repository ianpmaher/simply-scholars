            ...
            <body className={karla.className}>
                <div className="min-h-screen bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-sky-400 to-indigo-900">
                    ...
                    <div className="flex flex-1 flex-col sm:flex-row">
                        <Navbar className="sm:w-[12rem] order-first flex md:flex-col xs:flex-row justify-start items-center bg-[rgba(0,0,0,0.3)] rounded-xl" />
                        <main className="flex-1">{children}</main>
                        <Sidebar className="sm:w-[12rem] bg-[rgba(0,0,0,0.3)] text-white rounded-xl"  />
                    </div>
